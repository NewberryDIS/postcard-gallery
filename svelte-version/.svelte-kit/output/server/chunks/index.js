...
const Secret_header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<header class="secret-header svelte-1mfu9r6"><h1 class="svelte-1mfu9r6">${escape(title)}</h1> <a href="${escape(base, true) + "/"}" data-svelte-h="svelte-1j7lp8r"><img class="no-share svelte-1mfu9r6" src="${escape(base, true) + "/NLogo.png"}" alt="Logo for the Newberry Library"></a> </header>`;
});
/*! *****************************************************************************
...
const Masonry = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { items, defaultDirection = "end" } = $$props;
  if ($$props.items === void 0 && $$bindings.items && items !== void 0)
    $$bindings.items(items);
  if ($$props.defaultDirection === void 0 && $$bindings.defaultDirection && defaultDirection !== void 0)
    $$bindings.defaultDirection(defaultDirection);
  return `<div id="images" class="images">${validate_component(SvelteMasonryGrid, "MasonryGrid").$$render(
    $$result,
    {
      defaultDirection,
      id: "images",
