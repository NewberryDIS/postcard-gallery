import { C as CTX_API_TOKEN } from "../../../../chunks/private.js";
import { p as packageExtractor, m as mei } from "../../../../chunks/index.js";
...
const alldata = {
  APIRequestInfo: {
    ...
    Parameters: {
      ...
      PackageFields: "SystemIdentifier,Title,new.Context,CoreField.IIIFResourceType,MediaEncryptedIdentifier,MaxHeight,MaxWidthi,Link",
      RepresentativeFields: "SystemIdentifier,MediaEncryptedIdentifier,Title,MaxWidth,MaxHeight,CoreField.IIIFResourceType",
      ContentFields: "SystemIdentifier,MediaEncryptedIdentifier,Title,Link,CoreField.IIIFResourceType,MaxWidth,MaxHeight,MediaType,CoreField.Representative_Image_RecordID",
...
alldata.APIResponse.Content.map((c) => c.MediaEncryptedIdentifier);
async function load() {
