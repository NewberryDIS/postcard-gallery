...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const icons = [
    ...
    "mobile-sms-messages-icon",
    "quinn-icon"
  ];
  $$result.css.add(css);
  return `<main class="svelte-1t0jers"><table>${each(icons, (icon) => {
    return `<tr><td class="svelte-1t0jers"><img class="icon svelte-1t0jers" src="${escape(base, true) + "/" + escape(icon, true) + ".svg"}" alt=""></td> <td class="svelte-1t0jers"><object title="${escape(icon.replace("-", " "), true) + " icon"}" type="image/svg+xml" data="${escape(base, true) + "/" + escape(icon, true) + ".svg"}" class="icon svelte-1t0jers">Your browser does not support SVG
            </object></td> <td class="svelte-1t0jers"><h3>${escape(icon)}</h3></td> </tr>`;
  })} <div class="icon svelte-1t0jers">${validate_component(Envelope_icon, "EnvelopeIcon").$$render($$result, {}, {}, {})}<br></div> <div class="icon svelte-1t0jers">${validate_component(Hyperlink_icon, "HyperlinkIcon").$$render($$result, {}, {}, {})}<br></div> <div class="icon svelte-1t0jers">${validate_component(Letter_stamp_icon, "LetterStampIcon").$$render($$result, {}, {}, {})}<br></div> ${validate_component(Mobile_messages_icon, "MobileMessagesIcon").$$render($$result, {}, {}, {})}<br> ${validate_component(Mobile_sms_messages_icon, "MobileSmsMessagesIcon").$$render($$result, {}, {}, {})}<br> ${validate_component(Quinn_icon, "QuinnIcon").$$render($$result, {}, {}, {})}<br></table> </main>`;
});
export {
  Page as default
};
